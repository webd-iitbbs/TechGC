            ...
            <div className="row">
                ...
                <Carousel>
                    <Carousel.Item interval={1000}>
                        ...
                        <p className="carouseltext">14/03/21 - 28/03/21 | Abhivyakti</p>
                        </Carousel.Caption>
                    </Carousel.Item>
                    <Carousel.Item interval={1000}>
                        <a href="http://register.gciitbbs.live/" target="_blank">
                    ...
                    <Carousel.Item interval={1000}>
                        ...
                        <p className="carouseltext">27/02/21 | Kalakriti | 14:00 - 18:00</p>
                        </Carousel.Caption>
                    </Carousel.Item>
                    <Carousel.Item interval={1000}>
                        <a href="http://register.gciitbbs.live/" target="_blank">
                        ...
                        <p className="carouseltext">20/03/21 - 31/03/21 | Dramatics</p>
                        </Carousel.Caption>
                    </Carousel.Item>
                    <Carousel.Item interval={1000}>
                        <a href="http://register.gciitbbs.live/" target="_blank">
                        ...
                        <p className="carouseltext">23/03/21 - 01/04/21 | Clix</p>
                        </Carousel.Caption>
                    </Carousel.Item>
                    <Carousel.Item interval={1000}>
                        <a href="http://register.gciitbbs.live/" target="_blank">
                        ...
                        <p className="carouseltext">26/02/21 | Panacea | 18:00</p>
                        </Carousel.Caption>
                    </Carousel.Item>
                    <Carousel.Item interval={1000}>
                        <a href="http://register.gciitbbs.live/" target="_blank">
                        ...
                        <p className="carouseltext">28/02/21 | Panacea | 18:00</p>
                        </Carousel.Caption>
                    </Carousel.Item>
                    <Carousel.Item interval={1000}>
                        <a href="http://register.gciitbbs.live/" target="_blank">
                        ...
                        <p className="carouseltext">27/03/21 | QuizClub | 00:00</p>
                        </Carousel.Caption>
                    </Carousel.Item>
                    <Carousel.Item interval={1000}>
                        <a href="http://register.gciitbbs.live/" target="_blank">
                        ...
                        <p className="carouseltext">27/02/21 | QuizClub | 00:00</p>
                        </Carousel.Caption>
                    </Carousel.Item>
                    <Carousel.Item interval={1000}>
                        <a href="http://register.gciitbbs.live/" target="_blank">
                        ...
                        <p className="carouseltext">01/03/21 | QuizClub | 12:00</p>
                        </Carousel.Caption>
                    </Carousel.Item>
                    <Carousel.Item interval={1000}>
                        <a href="http://register.gciitbbs.live/" target="_blank">
                        ...
                        <p className="carouseltext">05/03/21 - 29/03/21 | Aaroh</p>
                        </Carousel.Caption>
                    </Carousel.Item>
                    <Carousel.Item interval={1000}>
                        <a href="http://register.gciitbbs.live/" target="_blank">
                    ...
                    <Carousel.Item interval={1000}>
                        ...
                        <p className="carouseltext">19/03/21 - 28/03/21 | Cinewave</p>
                        </Carousel.Caption>
                    </Carousel.Item>
                    <Carousel.Item interval={1000}>
                        <a href="http://register.gciitbbs.live/" target="_blank">
                        ...
                        <p className="carouseltext">18/03/21 - 04/04/21 | DGang</p>
                        </Carousel.Caption>
                    </Carousel.Item>
                </Carousel>
                </div>
